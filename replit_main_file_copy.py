...
def explain_predictions(probability, input_dict, surname):
  ...
  - If the customer has less than a 40% risk of churning, generate a 3 sentence explaination of why they might not be at risk of churning
  - Your explaination should be based on the customer's information, the summary statistics or churned and non-churned customers, and the most important features provided.
...
def generate_email(probability, input_dict, explaination, surname):
 ...
 Here is an explaination as to why the customer might be at risk of churning:
 {explaination}
...
if selected_customer_option:
  ...
  explaination = explain_predictions(avg_probability, input_dict,
